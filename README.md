...
# Run the FastAPI server on the network
uvicorn detect_api:app --reload --host 0.0.0.0 --port 8000  
```
# you would also need to install univcorn for the hosting of the fastapi server
#install ngrok 
#once installed do ngrok in a different terminal to see thr fastapi
#ngrok http 8000
